...
class CollectionController(GroupController):
    ...
    def index(self):
        ...
        try:
            ...
            h.flash_error(msg)
            c.page = h.Page([], 0)
            print self._index_template(group_type)
    ...
    def new(self, data=None, errors=None, error_summary=None):
        ...
        c.form = render(self._group_form(group_type=group_type),
                        extra_vars=vars)
        print self._new_template(group_type)
    ...
    def delete(self, id):
        ...
        try:
            ...
            h.redirect_to(controller='collection', action='read', id=id)
        return self._render_template('collection/confirm_delete.html', group_type)
    ...
    def members(self, id):
        ...
        return self._render_template('collection/members.html', group_type)
    ...
    def member_new(self, id):
        ...
        return self._render_template('collection/member_new.html', group_type)
    ...
    def member_delete(self, id):
        ...
        try:
            ...
            abort(404, _('Group not found'))
        return self._render_template('collection/confirm_delete_member.html',
                                     group_type)
    ...
    def activity(self, id, offset=0):
        '''Render this collection's public activity stream page.'''
